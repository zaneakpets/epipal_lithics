...
def eval_model_from_csv_files(train_embeddings_csv, valid_embeddings_csv, train_labels_csv, valid_labels_csv, experiment):
...
def get_class_names_dict_and_labels(labels_csv_file):
    cnt = 0
    clasee_names = {}
    labels = []
