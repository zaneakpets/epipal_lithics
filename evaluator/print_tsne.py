...
def plot_train_validation_set_tsnes(train_embeddings, valid_embeddings, train_labels, valid_labels, labels_names):

    #print( list(labels_names.values()))
    np.random.seed(7)
    X1 = train_embeddings
    ...
    #legend = fig.add_axes([0.85, 0.1, 0.02, 0.8])
    #fig.legend(im)
    #ticks = range(10)
    #cbar_ax.set_ticks(ticks)
    #cbar_ax.set_yticklabels(
    #    list(labels_names.values()))
...
if __name__ == '__main__':
    ...
    cls_names, train_labels =  get_class_names_dict_and_labels(train_labesl_csv)
    cls_list, valid_labels = get_class_names_dict_and_labels(valid_labesl_csv)
    ...
    plot_train_validation_set_tsnes(train_embeddings,valid_embeddings,train_labels,valid_labels,cls_names)