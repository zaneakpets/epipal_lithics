...
def get_communities(num_of_neighbors, is_self_loops, relevant_period_groups, full_confusion_csv, class_name_dict, similarty_csv = ''):
...
if __name__ == '__main__':
    ...
    summary = get_communities(40, True, -1, 'conf_mat_data/efficientNetB3_try7__data.csv', class_names)
